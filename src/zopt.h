...
#define CMDLINE_PARSER_VERSION "1.2.0-RC4"
#endif
...
struct gengetopt_args_info
{
  ...
  int max_ttl_arg;	/**< @brief Max ttl to use (for ROUTER scans).  */
  char * max_ttl_orig;	/**< @brief Max ttl to use (for ROUTER scans) original value given at command line.  */
  const char *max_ttl_help; /**< @brief Max ttl to use (for ROUTER scans) help description.  */
  ...
  unsigned int max_ttl_given ;	/**< @brief Whether max-ttl was given.  */
