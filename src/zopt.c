/*
  ...
  gengetopt -C --no-help --no-version --unamed-opts=SUBNETS -i /home/long/zmap/src/zopt.ggo -F /home/long/zmap/src/zopt 
...
#include "/home/long/zmap/src/zopt.h"

const char *gengetopt_args_info_purpose = "A fast Internet-wide scanner.";

const char *gengetopt_args_info_usage = "Usage: zmap [OPTIONS]... [SUBNETS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -m, --max-ttl=ttl             Max ttl to use (for ROUTER scans)",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->max_ttl_help = gengetopt_args_info_help[2] ;
  args_info->output_file_help = gengetopt_args_info_help[3] ;
  args_info->blacklist_file_help = gengetopt_args_info_help[4] ;
  args_info->whitelist_file_help = gengetopt_args_info_help[5] ;
  args_info->output_fields_help = gengetopt_args_info_help[6] ;
  args_info->max_targets_help = gengetopt_args_info_help[8] ;
  args_info->max_results_help = gengetopt_args_info_help[9] ;
  args_info->max_runtime_help = gengetopt_args_info_help[10] ;
  args_info->rate_help = gengetopt_args_info_help[11] ;
  args_info->bandwidth_help = gengetopt_args_info_help[12] ;
  args_info->cooldown_time_help = gengetopt_args_info_help[13] ;
  args_info->seed_help = gengetopt_args_info_help[14] ;
  args_info->sender_threads_help = gengetopt_args_info_help[15] ;
  args_info->probes_help = gengetopt_args_info_help[16] ;
  args_info->dryrun_help = gengetopt_args_info_help[17] ;
  args_info->shards_help = gengetopt_args_info_help[18] ;
  args_info->shard_help = gengetopt_args_info_help[19] ;
  args_info->source_port_help = gengetopt_args_info_help[21] ;
  args_info->source_ip_help = gengetopt_args_info_help[22] ;
  args_info->gateway_mac_help = gengetopt_args_info_help[23] ;
  args_info->interface_help = gengetopt_args_info_help[24] ;
  args_info->vpn_help = gengetopt_args_info_help[25] ;
  args_info->probe_module_help = gengetopt_args_info_help[27] ;
  args_info->output_module_help = gengetopt_args_info_help[28] ;
  args_info->probe_args_help = gengetopt_args_info_help[29] ;
  args_info->output_args_help = gengetopt_args_info_help[30] ;
  args_info->output_filter_help = gengetopt_args_info_help[31] ;
  args_info->list_output_modules_help = gengetopt_args_info_help[32] ;
  args_info->list_probe_modules_help = gengetopt_args_info_help[33] ;
  args_info->list_output_fields_help = gengetopt_args_info_help[34] ;
  args_info->config_help = gengetopt_args_info_help[36] ;
  args_info->log_file_help = gengetopt_args_info_help[37] ;
  args_info->log_directory_help = gengetopt_args_info_help[38] ;
  args_info->quiet_help = gengetopt_args_info_help[39] ;
  args_info->summary_help = gengetopt_args_info_help[40] ;
  args_info->metadata_file_help = gengetopt_args_info_help[41] ;
  args_info->disable_syslog_help = gengetopt_args_info_help[42] ;
  args_info->verbosity_help = gengetopt_args_info_help[43] ;
  args_info->help_help = gengetopt_args_info_help[44] ;
  args_info->version_help = gengetopt_args_info_help[45] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->max_ttl_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->max_ttl_given)
    write_into_file(outfile, "max-ttl", args_info->max_ttl_orig, 0);
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "p:m:o:b:w:f:n:N:t:r:B:c:e:T:P:ds:S:G:i:XM:O:C:l:L:qgv:hV", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'p':	/* TCP port number to scan (for SYN scans).  */
          ...
          break;
        case 'm':	/* Max ttl to use (for ROUTER scans).  */
        
        
          if (update_arg( (void *)&(args_info->max_ttl_arg), 
               &(args_info->max_ttl_orig), &(args_info->max_ttl_given),
              &(local_args_info.max_ttl_given), optarg, 0, 0, ARG_INT,
              check_ambiguity, override, 0, 0,
              "max-ttl", 'm',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "shards") == 0)
          {
